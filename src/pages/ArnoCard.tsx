  ...
  return (
    <div className="min-h-screen bg-[hsl(220,25%,6%)] text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md mx-auto px-5 py-12 flex flex-col items-center gap-6">
        ...
        {/* Save Contact Button — right after description */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <a
            ...
            className="group flex items-center gap-4 px-5 py-4 rounded-2xl border bg-white/[0.04] border-white/[0.08] hover:bg-white/[0.08] hover:border-white/[0.15] backdrop-blur-xl transition-all duration-300"
          >
            <span className="flex-shrink-0 text-white/50 group-hover:text-white/80 transition-colors">
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-4 px-5 py-4 rounded-2xl border bg-[hsl(142,70%,40%)]/10 border-[hsl(142,70%,40%)]/30 hover:bg-[hsl(142,70%,40%)]/20 hover:border-[hsl(142,70%,40%)]/50 backdrop-blur-xl transition-all duration-300"
          >
            <span className="flex-shrink-0 text-[hsl(142,70%,45%)] transition-colors">
